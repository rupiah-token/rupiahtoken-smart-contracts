...
contract("ERC20RupiahTokenV2 Blacklistable", function([
    owner,
    account_1,
    account_2,
    anotherAccount,
    ...
    describe("transfer from", function() {
        ...
        describe("allow when blacklisted then unblacklisted", function() {
            describe("the account is spender", function() {
                it("allows tx", async function() {
                    await this.token.unblacklist(account_1, {from: owner });
                    await this.token.transferFrom(account_2, anotherAccount, 10, {from: account_1});
            ...
            describe("the account is holder", function() {
                it("allows tx", async function() {
                    await this.token.unblacklist(account_1, {from: owner });
                    await this.token.transferFrom(account_1, anotherAccount, 10, {from: account_2});

...
const ERC20RupiahToken = artifacts.require("ERC20RupiahTokenL");
const RupiahFeeCollector = artifacts.require('RupiahFeeCollector');

// const ProxyAdmin = artifacts.require("ProxyAdmin");
const NETWORK = process.env.NETWORK;
const AdminUpgradeabilityProxy = artifacts.require("AdminUpgradeabilityProxy");
const deployedAddress = require('../migrations/deployed_addresses')[NETWORK];
const config = require('../migrations/config');
contract("ERC20RupiahTokenL", function([
  deployer,
  initialHolder,
  recipient,
  anotherAccount,
  ...
  beforeEach(async () => {
    ...
    rupiahFeeCollector = await RupiahFeeCollector.new([fromWhiteList1, fromWhitelist2, deployer], [toWhiteList1, toWhiteList2, deployer], [fromWhitelist2, normalAccount], [40, 60], token.address, 1, 100);

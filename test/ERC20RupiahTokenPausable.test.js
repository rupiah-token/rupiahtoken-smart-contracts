...
contract('ERC20RupiahToken Pausable', function ([owner, _, otherPauser, recipient, anotherAccount, ...otherAccounts]) {
  ...
  describe('pausable token', function () {
    ...
    describe('blacklist', function () {
      ...
      it('reverts when trying to blacklist when paused', async function () {
        ...
        await shouldFail.reverting(this.token.blacklist(anotherAccount, { from : owner }));
      });
    });
    ...
    describe('mint', function () {
      it('allows to mint when unpaused', async function () {
        ...
        (await this.token.balanceOf(anotherAccount)).should.be.bignumber.equal('1000');
      });
      ...
      it('reverts when trying to mint when paused', async function () {
        ...
        await shouldFail.reverting(this.token.mint(anotherAccount, 10, { from : owner }));
      });
    });
